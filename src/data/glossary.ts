...
export const glossary: GlossaryEntry[] = [
  ...
  },
  {
    ...
    full: "Josh.ai is a high-end voice control system that integrates with Savant, Lutron, Sonos, and other home automation platforms using natural-language commands processed locally for privacy.",
