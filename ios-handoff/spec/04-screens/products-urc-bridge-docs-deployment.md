# URC Deployment Guide — URC Rose Bridge | TCL

**Route:** `/products/urc-bridge/docs/deployment`
**OG Type:** website
**JSON-LD:** no

## Description
Step-by-step manual for URC dealers: install the Mac mini bridge and integrate it with URC Total Control 2.0 and MX HomePro.

## SwiftUI screen
- Suggested name: `ProductsUrcBridgeDocsDeploymentScreen`
